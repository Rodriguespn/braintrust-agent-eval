...
import type { RunnableExperimentConfig, EvalFixture } from './types.js';
  ...
  describe('concurrent execution', () => {
    it('runs all attempts concurrently', async () => {
      ...
      const fixtures: EvalFixture[] = [
        { name: 'eval-1', path: '/fake/path/eval-1', prompt: 'Test 1' },
        { name: 'eval-2', path: '/fake/path/eval-2', prompt: 'Test 2' },
      ];
